<aside class="z-20 flex-shrink-0 hidden w-64 overflow-y-auto bg-gray-100 dark:bg-gray-800 md:block">
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul class="mt-6">
            ...
            <!-- admission -->
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('admission.index') }}" :active="request()->routeIs('admission.index')">
                    ...
                    <span class="ml-4">{{ __('Admission') }}</span>
                </x-nav-link>
            </li>
            <!-- /. admission -->
        </ul>
        <ul>
            ...
            <li class="relative px-6 py-3">
                <button
                    class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    @click="toggleStudentOpen" aria-haspopup="true">
                    <span class="inline-flex items-center">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span class="ml-4">Academics</span>
                    </span>
                    <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
                            d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
